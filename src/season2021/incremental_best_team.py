from src.season2021.optimizer import get_best_teams_next_GP, FantasyTeam
...
if __name__ == '__main__':
    ...
    next_best_teams = get_best_teams_next_GP(current_team=current_team, include=include, exclude=exclude)
