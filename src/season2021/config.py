...
team1_driver1 = Driver(name="Hamilton",
                       ...
                       prices=[33.5, 33.4, 33.3, 33.3],
                       points=[45, 40, 43, 44],
                       race_positions=[1, 2, 1, 1],
                       qualy_positions=[2, 1, 2, 1])
team1_driver2 = Driver(name="Bottas",
                       start_point_expectation=25.59,
                       prices=[23.6, 23.5, 23.3, 23.3],
                       points=[32, -9, 32, 27],
                       race_positions=[3, 18, 3, 3],
                       qualy_positions=[3, 8, 1, 3])
team1 = Team(name="Mercedes",
             start_point_expectation=59.6,
             prices=[38.0, 37.8, 37.6, 37.6],
             points=[67, 36, 70, 66],
...
team2_driver1 = Driver(name="Verstappen",
                       ...
                       prices=[24.8, 25.1, 25.3, 25.3],
                       points=[35, 44, 37, 41],
                       race_positions=[2, 1, 2, 2],
                       qualy_positions=[1, 3, 3, 2])
team2_driver2 = Driver(name="Perez",
                       start_point_expectation=21.5,
                       prices=[18.4, 18.4, 18.3, 18.2],
                       points=[23, 5, 23, 23],
                       race_positions=[5, 11, 4, 5],
                       qualy_positions=[11, 2, 4, 8])
team2 = Team(name="Red Bull",
             start_point_expectation=48.0,
             prices=[25.9, 26.0, 26.1, 26.1],
             points=[53, 44, 55, 59],
...
team3_driver1 = Driver(name="Riccardo",
                       ...
                       prices=[17.3, 16.7, 16.5, 16.2],
                       points=[15, 19, 14, 23],
                       race_positions=[7, 6, 9, 6],
                       qualy_positions=[6, 6, 16, 7])
team3_driver2 = Driver(name="Norris",
                       start_point_expectation=17.71,
                       prices=[13.1, 13.4, 13.7, 13.9],
                       points=[29, 34, 27, 12],
                       race_positions=[4, 3, 5, 8],
                       qualy_positions=[7, 7, 7, 9])
team3 = Team(name="McLaren",
             start_point_expectation=30.4,
             prices=[18.9, 18.7, 18.8, 18.9],
             points=[39, 48, 46, 30],
...
team4_driver1 = Driver(name="Leclerc",
                       ...
                       prices=[16.8, 17.4, 17.8, 18.0],
                       points=[20, 28, 22, 28],
                       race_positions=[6, 4, 6, 4],
                       qualy_positions=[4, 4, 8, 4])
team4_driver2 = Driver(name="Sainz",
                       start_point_expectation=12.0,
                       prices=[14.4, 14.3, 14.4, 14.3],
                       points=[11, 23, 2, 13],
                       race_positions=[8, 5, 11, 7],
                       qualy_positions=[8, 11, 5, 6])
team4 = Team(name="Ferrari",
             start_point_expectation=21.5,
             prices=[18.1, 18.7, 18.9, 18.7],
             points=[26, 46, 19, 36],
...
team5_driver1 = Driver(name="Vettel",
                       ...
                       prices=[16.2, 15.4, 15.1, 15.0],
                       points=[12, 1, 4, 3],
                       race_positions=[15, 15, 13, 13],
                       qualy_positions=[18, 13, 10, 13])
team5_driver2 = Driver(name="Stroll",
                       start_point_expectation=10.53,
                       prices=[13.9, 13.6, 13.6, 13.5],
                       points=[11, 22, 8, 8],
                       race_positions=[10, 7, 14, 11],
                       qualy_positions=[10, 10, 17, 11])
team5 = Team(name="Aston Martin",
             start_point_expectation=28.9,
             prices=[17.6, 16.9, 16.6, 16.5],
             points=[18, 18, 7, 6],
...
team6_driver1 = Driver(name="Alonso",
                       ...
                       prices=[15.6, 15.2, 15.0, 15.0],
                       points=[-8, 14, 17, -5],
                       race_positions=[19, 10, 8, 17],
                       qualy_positions=[9, 15, 13, 10])
team6_driver2 = Driver(name="Ocon",
                       start_point_expectation=8.76,
                       prices=[10.1, 9.7, 9.9, 10.3],
                       points=[11, 13, 18, 9],
                       race_positions=[13, 9, 7, 9],
                       qualy_positions=[16, 9, 6, 5])
team6 = Team(name="Alpine",
             start_point_expectation=28.1,
             prices=[15.4, 15.1, 15.0, 15.2],
             points=[13, 16, 30, -1],
...
team7_driver1 = Driver(name="Gasly",
                       ...
                       prices=[11.7, 11.7, 11.7, 11.7],
                       points=[2, 13, 10, 13],
                       race_positions=[17, 8, 10, 10],
                       qualy_positions=[5, 5, 9, 12])
team7_driver2 = Driver(name="Tsunoda",
                       start_point_expectation=9.0,
                       prices=[8.8, 9.4, 9.2, 8.9],
                       points=[16, 6, 2, -14],
                       race_positions=[9, 12, 15, 20],
                       qualy_positions=[13, 20, 14, 16])
team7 = Team(name="Alpha Tauri",
             start_point_expectation=20.9,
             prices=[12.7, 13.2, 13.0, 12.8],
             points=[13, 19, 7, 9],
...
team8_driver1 = Driver(name="Raikkonen",
                       start_point_expectation=10.53,
                       prices=[9.6, 9.4, 9.4, 9.3],
                       points=[12, 13, -13, 15],
                       race_positions=[11, 13, 20, 12],
                       qualy_positions=[14, 16, 15, 17])
team8_driver2 = Driver(name="Giovinazzi",
                       start_point_expectation=6.06,
                       prices=[7.9, 7.8, 7.8, 7.8],
                       points=[5, 8, 8, 4],
                       race_positions=[12, 14, 12, 15],
                       qualy_positions=[12, 17, 12, 14])
team8 = Team(name="Alfa Romeo",
             start_point_expectation=15.1,
             prices=[8.9, 8.9, 8.9, 8.9],
             points=[12, 22, 5, 14],
...
team9_driver1 = Driver(name="Latifi",
                       ...
                       prices=[6.5, 6.5, 6.5, 6.4],
                       points=[1, -13, 2, 8],
                       race_positions=[18, 18, 18, 16],
                       qualy_positions=[17, 14, 18, 19])
team9_driver2 = Driver(name="Russel",
                       start_point_expectation=4.53,
                       prices=[6.2, 6.2, 6.2, 6.3],
                       points=[10, -11, 3, 10],
                       race_positions=[14, 18, 16, 14],
                       qualy_positions=[15, 12, 11, 15])
team9 = Team(name="Williams",
             start_point_expectation=10.4,
             prices=[6.3, 6.3, 6.3, 6.3],
             points=[6, 4, 0, 13],
...
team10_driver1 = Driver(name="Schumacher",
                        ...
                        prices=[5.8, 5.7, 5.7, 5.8],
                        points=[11, 11, 11, 7],
                        race_positions=[16, 16, 17, 18],
                        qualy_positions=[19, 18, 19, 18])
team10_driver2 = Driver(name="Mazepin",
                        start_point_expectation=4.0,
                        prices=[5.5, 5.3, 5.3, 5.3],
                        points=[-14, 6, 4, 4],
                        race_positions=[19, 17, 18, 19],
                        qualy_positions=[20, 19, 20, 20])
team10 = Team(name="Haas",
              start_point_expectation=9.6,
              prices=[6.1, 6.1, 6.1, 6.1],
              points=[7, 12, 10, 6],
